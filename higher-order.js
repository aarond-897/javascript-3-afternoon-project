...
//Code Here
let myStrongest = monstersInYourPocket.filter(number=> number.CP>200)
...
let bobsTotal = purchases.filter(element=>element.owner==="Bob").reduce((total,value)=>total+value.price,0)
